...
const OpportunityCard = ({ spanText, title, body, image, footer }) => {
  return (
    <article className="bg-white p-4 md:p-8 rounded-lg shadow-md border border-gray-200 hover:border-black hover:shadow-lg">
      <div className="flex flex-col gap-y-4 justify-between bg-gray-100 px-4 min-h-[460px] md:px-6 py-3 rounded-lg">
